 ...
 * every host runtime that gives its device arguments a buffer.
 *
 ...
 * grow and slice logic lives here. A bind packs its own device arguments to a
 ...
 * leases never share a temporary buffer.
 *
